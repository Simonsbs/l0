...
pat_gep_mid_b: .ascii " = alloca t0, 1 : t1\n  st v"
pat_gep_mid_b_len = . - pat_gep_mid_b
...
.tsgr_alloca_vid_done:
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_b_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_b]
    mov rdx, pat_gep_mid_b_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
    add r10, pat_gep_mid_b_len
