...
code_stub_trace_noop: .byte 0x48,0x31,0xc0,0xc3
code_stub_trace_noop_len = . - code_stub_trace_noop
...
pat_trace_noop: .ascii "fn f0 (t0)->t0 {\nb0:\n  v0 = arg 0 : t0\n  trace 1 v0\n  v1 = const 0 : t0\n  ret v1\n}\n"
...
do_build:
    ...
    lea rdi, [rip+file_buf]
    mov rsi, rbx
    lea rdx, [rip+pat_trace_noop]
    mov rcx, pat_trace_noop_len
    call find_substr
    cmp rax, 1
    jne .build_try_write_newline
    lea r14, [rip+code_stub_trace_noop]
    mov r15, code_stub_trace_noop_len
