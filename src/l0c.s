...
code_stub_sub_rev: .byte 0x48,0x89,0xf0,0x48,0x29,0xf8,0xc3
code_stub_sub_rev_len = . - code_stub_sub_rev
...
pat_mem_mid_b_tail_len = . - pat_mem_mid_b_tail
...
pat_gep_head: .ascii "fn f0 (t0)->t0 {\nb0:\n  v"
...
pat_gep_mid_b_tail_len = . - pat_gep_mid_b_tail
pat_gep_mid_c: .ascii " v"
pat_gep_mid_c_len = . - pat_gep_mid_c
pat_gep_mid_d: .ascii "\n  v"
pat_gep_mid_d_len = . - pat_gep_mid_d
pat_gep_mid_e: .ascii " = gep v"
pat_gep_mid_e_len = . - pat_gep_mid_e
pat_gep_mid_f: .ascii " 0 : t1\n  v"
pat_gep_mid_f_len = . - pat_gep_mid_f
pat_gep_mid_g: .ascii " = ld v"
pat_gep_mid_g_len = . - pat_gep_mid_g
pat_gep_mid_h: .ascii " : t0\n  ret v"
pat_gep_mid_h_len = . - pat_gep_mid_h
pat_gep_tail: .ascii "\n}\n"
pat_gep_tail_len = . - pat_gep_tail
...
pat_call_tail_b_head: .ascii "\n}\nfn f1 (t0,t0)->t0 {\nb0:\n  v0 = arg 0 : t0\n  v1 = arg 1 : t0\n  v"
pat_call_tail_b_head_len = . - pat_call_tail_b_head
pat_call_tail_b_head_alt: .ascii "\n}\nfn f1 (t0,t0)->t0 {\nb0:\n  v1 = arg 0 : t0\n  v0 = arg 1 : t0\n  v"
pat_call_tail_b_head_alt_len = . - pat_call_tail_b_head_alt
...
pat_call_tail_b_mid_sub_swapped: .ascii " = sub.wrap v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_sub_swapped_len = . - pat_call_tail_b_mid_sub_swapped
...
pat_call_tail_b_mid_and: .ascii " = and v0 v1 : t0\n  ret v"
pat_call_tail_b_mid_and_len = . - pat_call_tail_b_mid_and
pat_call_tail_b_mid_and_swapped: .ascii " = and v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_and_swapped_len = . - pat_call_tail_b_mid_and_swapped
pat_call_tail_b_mid_or: .ascii " = or v0 v1 : t0\n  ret v"
pat_call_tail_b_mid_or_len = . - pat_call_tail_b_mid_or
pat_call_tail_b_mid_or_swapped: .ascii " = or v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_or_swapped_len = . - pat_call_tail_b_mid_or_swapped
pat_call_tail_b_mid_xor: .ascii " = xor v0 v1 : t0\n  ret v"
pat_call_tail_b_mid_xor_len = . - pat_call_tail_b_mid_xor
pat_call_tail_b_mid_xor_swapped: .ascii " = xor v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_xor_swapped_len = . - pat_call_tail_b_mid_xor_swapped
pat_call_tail_b_mid_shl: .ascii " = shl v0 v1 : t0\n  ret v"
pat_call_tail_b_mid_shl_len = . - pat_call_tail_b_mid_shl
pat_call_tail_b_mid_shl_swapped: .ascii " = shl v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_shl_swapped_len = . - pat_call_tail_b_mid_shl_swapped
pat_call_tail_b_mid_shr: .ascii " = shr v0 v1 : t0\n  ret v"
pat_call_tail_b_mid_shr_len = . - pat_call_tail_b_mid_shr
pat_call_tail_b_mid_shr_swapped: .ascii " = shr v1 v0 : t0\n  ret v"
pat_call_tail_b_mid_shr_swapped_len = . - pat_call_tail_b_mid_shr_swapped
...
# try_select_mem_gep_roundtrip_kernel_code
# rdi=src_ptr, rsi=src_len
# out: rax=1 if selected and sets r14/r15 ; 0 otherwise
try_select_mem_gep_roundtrip_kernel_code:
    push rbx
    ...
    mov r12, rdi
    mov r13, rsi
    lea rdx, [rip+pat_gep_head]
    mov rcx, pat_gep_head_len
    mov rdi, r12
    mov rsi, r13
    call find_substr_pos
    cmp rax, -1
    ...
    mov r8, rax
    add r8, pat_gep_head_len         # arg-id start
    cmp r8, r13
    jae .tsgr_no
    mov r9, r8
.tsgr_arg_vid_loop:
    ...
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsgr_arg_vid_done
    cmp al, '9'
    ja .tsgr_arg_vid_done
    inc r9
    jmp .tsgr_arg_vid_loop
.tsgr_arg_vid_done:
    cmp r9, r8
    je .tsgr_no
    mov rbx, r8
    ...
    mov r8, r10
    mov r9, r8
.tsgr_alloca_vid_loop:
    cmp r9, r13
    jae .tsgr_no
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsgr_alloca_vid_done
    cmp al, '9'
    ja .tsgr_alloca_vid_done
    inc r9
    jmp .tsgr_alloca_vid_loop
.tsgr_alloca_vid_done:
    cmp r9, r8
    je .tsgr_no
    mov r14, r8
    mov r15, r9
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_b_head_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_b_head]
    mov rdx, pat_gep_mid_b_head_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
    add r10, pat_gep_mid_b_head_len
    cmp r10, r13
    jae .tsgr_no
    mov r8, r10
    mov r9, r8
.tsgr_alloca_count_loop:
    cmp r9, r13
    jae .tsgr_alloca_count_done
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsgr_alloca_count_done
    cmp al, '9'
    ja .tsgr_alloca_count_done
    inc r9
    jmp .tsgr_alloca_count_loop
.tsgr_alloca_count_done:
    cmp r9, r8
    je .tsgr_no
    xor rcx, rcx
    mov rax, r8
.tsgr_alloca_count_nz_loop:
    cmp rax, r9
    jae .tsgr_alloca_count_nz_done
    mov dl, byte ptr [r12+rax]
    cmp dl, '0'
    jne .tsgr_alloca_count_nz_yes
    inc rax
    jmp .tsgr_alloca_count_nz_loop
.tsgr_alloca_count_nz_yes:
    mov rcx, 1
.tsgr_alloca_count_nz_done:
    cmp rcx, 1
    jne .tsgr_no
    mov r10, r9
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_b_tail_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_b_tail]
    mov rdx, pat_gep_mid_b_tail_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
...
.tsgr_defs_ready:
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_c_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_c]
    mov rdx, pat_gep_mid_c_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
    add r10, pat_gep_mid_c_len
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_d_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_d]
    mov rdx, pat_gep_mid_d_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
    add r10, pat_gep_mid_d_len       # gep-id start
    cmp r10, r13
    jae .tsgr_no
...
.tsgr_gep_vid_loop:
    ...
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsgr_gep_vid_done
    cmp al, '9'
    ja .tsgr_gep_vid_done
    inc r9
    jmp .tsgr_gep_vid_loop
.tsgr_gep_vid_done:
    cmp r9, r8
    je .tsgr_no
    mov rbx, r8
    mov r11, r9
    sub r11, r8                      # gep-id len
    push rbx
    push r11
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_e_len
    jb .tsgr_no_pop_gep
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_e]
    mov rdx, pat_gep_mid_e_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no_pop_gep
    add r10, pat_gep_mid_e_len
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_f_len
    jb .tsgr_no_pop_gep
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_f]
    mov rdx, pat_gep_mid_f_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no_pop_gep
    add r10, pat_gep_mid_f_len       # ld-id start
    cmp r10, r13
    jae .tsgr_no_pop_gep
...
.tsgr_ld_vid_loop:
    ...
    ja .tsgr_ld_vid_done
    inc r9
    jmp .tsgr_ld_vid_loop
.tsgr_ld_vid_done:
    cmp r9, r8
    je .tsgr_no_pop_gep
    mov rbx, r8
    mov r11, r9
    sub r11, r8                      # ld-id len

    mov r10, r9
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_g_len
    jb .tsgr_no_pop_gep
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_g]
    mov rdx, pat_gep_mid_g_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no_pop_gep
    add r10, pat_gep_mid_g_len
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_mid_h_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_mid_h]
    mov rdx, pat_gep_mid_h_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
    add r10, pat_gep_mid_h_len
...
.tsgr_ret_id_done:
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_gep_tail_len
    jb .tsgr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_gep_tail]
    mov rdx, pat_gep_tail_len
    call mem_eq
    cmp rax, 1
    jne .tsgr_no
...
.tsmr_alloca_vid_done:
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_mem_mid_b_head_len
    jb .tsmr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_mem_mid_b_head]
    mov rdx, pat_mem_mid_b_head_len
    call mem_eq
    cmp rax, 1
    jne .tsmr_no
    add r10, pat_mem_mid_b_head_len
    cmp r10, r13
    jae .tsmr_no
    mov r8, r10
    mov r9, r8
.tsmr_alloca_count_loop:
    cmp r9, r13
    jae .tsmr_alloca_count_done
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsmr_alloca_count_done
    cmp al, '9'
    ja .tsmr_alloca_count_done
    inc r9
    jmp .tsmr_alloca_count_loop
.tsmr_alloca_count_done:
    cmp r9, r8
    je .tsmr_no
    xor rcx, rcx
    mov rax, r8
.tsmr_alloca_count_nz_loop:
    cmp rax, r9
    jae .tsmr_alloca_count_nz_done
    mov dl, byte ptr [r12+rax]
    cmp dl, '0'
    jne .tsmr_alloca_count_nz_yes
    inc rax
    jmp .tsmr_alloca_count_nz_loop
.tsmr_alloca_count_nz_yes:
    mov rcx, 1
.tsmr_alloca_count_nz_done:
    cmp rcx, 1
    jne .tsmr_no
    mov r10, r9
    mov rax, r13
    sub rax, r10
    cmp rax, pat_mem_mid_b_tail_len
    jb .tsmr_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_mem_mid_b_tail]
    mov rdx, pat_mem_mid_b_tail_len
    call mem_eq
    cmp rax, 1
    jne .tsmr_no
...
.tsck_call_vid_done:
    ...
    add rcx, 1
    add rcx, pat_call_tail_b_mid_add_len
    add rcx, 1
...
.tsck_call_add_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_add_swapped
    mov r9, r8
.tsck_call_add_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_add_swapped
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_add_f1_vid_done
    cmp al, '9'
    ja .tsck_call_add_f1_vid_done
    inc r9
    jmp .tsck_call_add_f1_vid_loop
.tsck_call_add_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_add_swapped
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_add_len
    jb .tsck_call_try_add_swapped
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_add]
...
.tsck_call_try_add_swapped:
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_add_swapped_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_sub
    mov qword ptr [rsp+8], 1
.tsck_call_add_swapped_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_sub
    mov r9, r8
.tsck_call_add_swapped_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_sub
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_add_swapped_f1_vid_done
    cmp al, '9'
    ja .tsck_call_add_swapped_f1_vid_done
    inc r9
    jmp .tsck_call_add_swapped_f1_vid_loop
.tsck_call_add_swapped_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_sub
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
...
.tsck_call_sub_len_ready:
    ...
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_sub_len
    add rcx, 1
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
...
.tsck_call_sub_head_advance_done:
    ...
    jne .tsck_call_try_mul
    mov qword ptr [rsp+8], 1
.tsck_call_sub_f1_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_mul
    mov r9, r8
.tsck_call_sub_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_mul
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_sub_f1_vid_done
    cmp al, '9'
    ja .tsck_call_sub_f1_vid_done
    inc r9
    jmp .tsck_call_sub_f1_vid_loop
.tsck_call_sub_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_mul
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_sub_len
    jb .tsck_call_try_mul
    mov rdi, r12
    add rdi, r8
...
.tsck_call_try_mul:
    # non-commutative sub reverse mapping: semantic arg1->arg0
    mov rax, r13
    sub rax, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_sub_rev_len_canon
    mov rcx, pat_call_tail_a_len
    jmp .tsck_call_sub_rev_len_ready
.tsck_call_sub_rev_len_canon:
    mov rcx, pat_call_tail_a_swapped_len
.tsck_call_sub_rev_len_ready:
    add rcx, r11
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_sub_len
    ...
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
    jb .tsck_call_try_mul_real
    mov rdi, r12
    add rdi, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_sub_rev_head_canon
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
    jmp .tsck_call_sub_rev_head_ready
.tsck_call_sub_rev_head_canon:
    lea rsi, [rip+pat_call_tail_a_swapped]
    mov rdx, pat_call_tail_a_swapped_len
.tsck_call_sub_rev_head_ready:
    call mem_eq
    cmp rax, 1
    jne .tsck_call_try_mul_real
    mov rdi, r12
    add rdi, r10
    add rdi, pat_call_tail_a_len
    mov rsi, r12
    ...
    mov r8, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_sub_rev_head_advance_canon
    add r8, pat_call_tail_a_len
    jmp .tsck_call_sub_rev_head_advance_done
.tsck_call_sub_rev_head_advance_canon:
    add r8, pat_call_tail_a_swapped_len
.tsck_call_sub_rev_head_advance_done:
    add r8, r11
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_head_len
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_sub_rev_f1_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_mul_real
    mov qword ptr [rsp+8], 1
.tsck_call_sub_rev_f1_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_mul_real
    mov r9, r8
.tsck_call_sub_rev_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_mul_real
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_sub_rev_f1_vid_done
    cmp al, '9'
    ja .tsck_call_sub_rev_f1_vid_done
    inc r9
    jmp .tsck_call_sub_rev_f1_vid_loop
.tsck_call_sub_rev_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_mul_real
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    ...
    add rdi, r8
    cmp qword ptr [rsp+8], 1
    jne .tsck_call_sub_rev_f1_mid_canon
    lea rsi, [rip+pat_call_tail_b_mid_sub_swapped]
    mov rdx, pat_call_tail_b_mid_sub_swapped_len
    jmp .tsck_call_sub_rev_f1_mid_ready
.tsck_call_sub_rev_f1_mid_canon:
    lea rsi, [rip+pat_call_tail_b_mid_sub]
    mov rdx, pat_call_tail_b_mid_sub_len
.tsck_call_sub_rev_f1_mid_ready:
    call mem_eq
    cmp rax, 1
    jne .tsck_call_try_mul_real
    add r8, pat_call_tail_b_mid_sub_len
...
.tsck_call_try_mul_real:
    ...
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_mul_len
    add rcx, 1
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
    ...
    jne .tsck_call_try_mul_swapped
    mov qword ptr [rsp+8], 1
.tsck_call_mul_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_mul_swapped
    mov r9, r8
.tsck_call_mul_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_mul_swapped
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_mul_f1_vid_done
    cmp al, '9'
    ja .tsck_call_mul_f1_vid_done
    inc r9
    jmp .tsck_call_mul_f1_vid_loop
.tsck_call_mul_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_mul_swapped
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_mul_len
    jb .tsck_call_try_mul_swapped
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_mul]
...
.tsck_call_try_mul_swapped:
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_mul_swapped_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_and
    mov qword ptr [rsp+8], 1
.tsck_call_mul_swapped_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_and
    mov r9, r8
.tsck_call_mul_swapped_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_and
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_mul_swapped_f1_vid_done
    cmp al, '9'
    ja .tsck_call_mul_swapped_f1_vid_done
    inc r9
    jmp .tsck_call_mul_swapped_f1_vid_loop
.tsck_call_mul_swapped_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_and
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
...
.tsck_call_try_and:
    ...
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_and_len
    add rcx, 1
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
    jb .tsck_call_try_and_swapped
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
    ...
    jne .tsck_call_try_and_swapped
    mov qword ptr [rsp+8], 1
.tsck_call_and_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_and_swapped
    mov r9, r8
.tsck_call_and_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_and_swapped
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_and_f1_vid_done
    cmp al, '9'
    ja .tsck_call_and_f1_vid_done
    inc r9
    jmp .tsck_call_and_f1_vid_loop
.tsck_call_and_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_and_swapped
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_and_len
    jb .tsck_call_try_and_swapped
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_and]
    mov rdx, pat_call_tail_b_mid_and_len
    call mem_eq
    cmp rax, 1
    je .tsck_call_and_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_and_swapped]
    mov rdx, pat_call_tail_b_mid_and_swapped_len
    call mem_eq
    cmp rax, 1
    jne .tsck_call_try_and_swapped
.tsck_call_and_mid_ok:
    add r8, pat_call_tail_b_mid_and_len
    mov rdi, r12
    add rdi, r8
    mov rsi, r12
    add rsi, r14
...
.tsck_call_try_and_swapped:
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_and_swapped_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_or
    mov qword ptr [rsp+8], 1
.tsck_call_and_swapped_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_or
    mov r9, r8
.tsck_call_and_swapped_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_or
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_and_swapped_f1_vid_done
    cmp al, '9'
    ja .tsck_call_and_swapped_f1_vid_done
    inc r9
    jmp .tsck_call_and_swapped_f1_vid_loop
.tsck_call_and_swapped_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_or
    mov r14, r8
    mov r15, r9
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_and_swapped_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_and_swapped]
    mov rdx, pat_call_tail_b_mid_and_swapped_len
...
.tsck_call_try_or:
    ...
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_or_len
    add rcx, 1
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
    jb .tsck_call_try_or_swapped
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
    ...
    jne .tsck_call_try_or_swapped
    mov qword ptr [rsp+8], 1
.tsck_call_or_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_or_swapped
    mov r9, r8
.tsck_call_or_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_or_swapped
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_or_f1_vid_done
    cmp al, '9'
    ja .tsck_call_or_f1_vid_done
    inc r9
    jmp .tsck_call_or_f1_vid_loop
.tsck_call_or_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_or_swapped
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_or_len
    jb .tsck_call_try_or_swapped
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_or]
    mov rdx, pat_call_tail_b_mid_or_len
    call mem_eq
    cmp rax, 1
    je .tsck_call_or_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_or_swapped]
    mov rdx, pat_call_tail_b_mid_or_swapped_len
    call mem_eq
    cmp rax, 1
    jne .tsck_call_try_or_swapped
.tsck_call_or_mid_ok:
    add r8, pat_call_tail_b_mid_or_len
    mov rdi, r12
    add rdi, r8
    mov rsi, r12
    add rsi, r14
...
.tsck_call_try_or_swapped:
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_or_swapped_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_xor
    mov qword ptr [rsp+8], 1
.tsck_call_or_swapped_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_xor
    mov r9, r8
.tsck_call_or_swapped_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_xor
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_or_swapped_f1_vid_done
    cmp al, '9'
    ja .tsck_call_or_swapped_f1_vid_done
    inc r9
    jmp .tsck_call_or_swapped_f1_vid_loop
.tsck_call_or_swapped_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_xor
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_or_swapped_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_or_swapped]
    mov rdx, pat_call_tail_b_mid_or_swapped_len
...
.tsck_call_try_xor:
    ...
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    add rcx, pat_call_tail_b_mid_xor_len
    add rcx, 1
    add rcx, pat_call_tail_b_tail_len
    cmp rax, rcx
    jb .tsck_call_try_xor_swapped
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
    ...
    jne .tsck_call_try_xor_swapped
    mov qword ptr [rsp+8], 1
.tsck_call_xor_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_xor_swapped
    mov r9, r8
.tsck_call_xor_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_xor_swapped
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_xor_f1_vid_done
    cmp al, '9'
    ja .tsck_call_xor_f1_vid_done
    inc r9
    jmp .tsck_call_xor_f1_vid_loop
.tsck_call_xor_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_xor_swapped
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_mid_xor_len
    jb .tsck_call_try_xor_swapped
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_xor]
    mov rdx, pat_call_tail_b_mid_xor_len
    call mem_eq
    cmp rax, 1
    je .tsck_call_xor_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_xor_swapped]
    mov rdx, pat_call_tail_b_mid_xor_swapped_len
    call mem_eq
    cmp rax, 1
    jne .tsck_call_try_xor_swapped
.tsck_call_xor_mid_ok:
    add r8, pat_call_tail_b_mid_xor_len
    mov rdi, r12
    add rdi, r8
    mov rsi, r12
    add rsi, r14
...
.tsck_call_try_xor_swapped:
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_xor_swapped_head_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_head_alt]
    mov rdx, pat_call_tail_b_head_alt_len
    ...
    jne .tsck_call_try_shl
    mov qword ptr [rsp+8], 1
.tsck_call_xor_swapped_head_ok:
    add r8, pat_call_tail_b_head_len
    cmp r8, r13
    jae .tsck_call_try_shl
    mov r9, r8
.tsck_call_xor_swapped_f1_vid_loop:
    cmp r9, r13
    jae .tsck_call_try_shl
    mov al, byte ptr [r12+r9]
    cmp al, '0'
    jb .tsck_call_xor_swapped_f1_vid_done
    cmp al, '9'
    ja .tsck_call_xor_swapped_f1_vid_done
    inc r9
    jmp .tsck_call_xor_swapped_f1_vid_loop
.tsck_call_xor_swapped_f1_vid_done:
    cmp r9, r8
    je .tsck_call_try_shl
    mov r14, r8
    mov r15, r9
    sub r15, r8
    mov r8, r9
    ...
    call mem_eq
    cmp rax, 1
    je .tsck_call_xor_swapped_mid_ok
    mov rdi, r12
    add rdi, r8
    lea rsi, [rip+pat_call_tail_b_mid_xor_swapped]
    mov rdx, pat_call_tail_b_mid_xor_swapped_len
...
.tsck_call_try_shl:
    ...
    sub rax, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_shl_len_canon
    mov rcx, pat_call_tail_a_swapped_len
    jmp .tsck_call_shl_len_ready
.tsck_call_shl_len_canon:
    mov rcx, pat_call_tail_a_len
.tsck_call_shl_len_ready:
    add rcx, r11
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    ...
    add rdi, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_shl_head_canon
    lea rsi, [rip+pat_call_tail_a_swapped]
    mov rdx, pat_call_tail_a_swapped_len
    jmp .tsck_call_shl_head_ready
.tsck_call_shl_head_canon:
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
.tsck_call_shl_head_ready:
    ...
    add r8, pat_call_tail_a_swapped_len
    jmp .tsck_call_shl_head_advance_done
.tsck_call_shl_head_advance_canon:
    add r8, pat_call_tail_a_len
.tsck_call_shl_head_advance_done:
    add r8, r11
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_head_len
...
.tsck_call_try_shr:
    ...
    sub rax, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_shr_len_canon
    mov rcx, pat_call_tail_a_swapped_len
    jmp .tsck_call_shr_len_ready
.tsck_call_shr_len_canon:
    mov rcx, pat_call_tail_a_len
.tsck_call_shr_len_ready:
    add rcx, r11
    add rcx, pat_call_tail_b_head_len
    add rcx, 1
    ...
    add rdi, r10
    cmp qword ptr [rsp], 1
    jne .tsck_call_shr_head_canon
    lea rsi, [rip+pat_call_tail_a_swapped]
    mov rdx, pat_call_tail_a_swapped_len
    jmp .tsck_call_shr_head_ready
.tsck_call_shr_head_canon:
    lea rsi, [rip+pat_call_tail_a]
    mov rdx, pat_call_tail_a_len
.tsck_call_shr_head_ready:
    ...
    add r8, pat_call_tail_a_swapped_len
    jmp .tsck_call_shr_head_advance_done
.tsck_call_shr_head_advance_canon:
    add r8, pat_call_tail_a_len
.tsck_call_shr_head_advance_done:
    add r8, r11
    mov rax, r13
    sub rax, r8
    cmp rax, pat_call_tail_b_head_len
...
try_select_bin_kernel_code:
    ...
    mov r8, rax
    add r8, pat_bin_head_len        # arg0-id start
    cmp r8, r13
    jae .tsbk_no
...
.tsbk_arg0_done:
    ...
    mov rax, r13
    sub rax, r10
    cmp rax, pat_bin_mid_a_len
    jb .tsbk_no
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_bin_mid_a]
...
.tsbk_arg1_done:
    ...
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_bin_mid_b]
    mov rdx, pat_bin_mid_b_len
    call mem_eq
    cmp rax, 1
    jne .tsbk_no
...
.tsbk_space:
    ...
    mov r10, r9
    inc r10                           # operands start
    cmp r10, r13
    jae .tsbk_no
    mov al, byte ptr [r12+r10]
    cmp al, 'v'
    jne .tsbk_no
    inc r10                           # op1 digits start
    mov r8, r10
    mov r9, r8
.tsbk_find_op1_end:
    cmp r9, r13
...
.tsbk_op2_done:
    ...
    mov rdi, r12
    add rdi, r10
    lea rsi, [rip+pat_bin_tail_mid]
    mov rdx, pat_bin_tail_mid_len
    call mem_eq
    cmp rax, 1
    jne .tsbk_no
    add r10, pat_bin_tail_mid_len
    mov rdi, r12
    add rdi, r10
    mov rsi, r12
    add rsi, qword ptr [rsp+32]
    ...
    # operand order flag: 0=arg0,arg1 ; 1=arg1,arg0
    mov qword ptr [rsp+80], 0
    mov rax, qword ptr [rsp+56]
    cmp rax, qword ptr [rsp+8]
    jne .tsbk_try_swapped
    mov rdi, r12
    add rdi, qword ptr [rsp+48]
    mov rsi, r12
    add rsi, qword ptr [rsp+0]
