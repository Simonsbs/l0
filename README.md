...
- I track full non-template multi-block backend/codegen completion and const-dependent intrinsic dead-const lowering (from deterministic fallback to lowered closure) as my next milestone (M27).
